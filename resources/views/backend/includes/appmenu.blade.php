    ...
    <div id="scrollbar">
        <div class="container-fluid">
            ...
            <ul class="navbar-nav" id="navbar-nav">
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarSchoolSetup" data-bs-toggle="collapse"
                        role="button" aria-expanded="false" aria-controls="sidebarSchoolSetup">
                        <i class="mdi mdi-town-hall"></i> <span
                            data-key="t-layouts">School Setup</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarSchoolSetup">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('school-setup.index') }}" class="nav-link" data-key="t-horizontal">Setup</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarBanner" data-bs-toggle="collapse"
                        ...
                        <i class="mdi mdi-folder-image"></i> <span
                            data-key="t-layouts">Manage Banner</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarBanner">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('banner.index') }}" class="nav-link" data-key="t-horizontal">Banners</a>
                            </li>
                        </ul>
                    </div>
                </li>
                ...
                <li class="nav-item">
                    <a class="nav-link menu-link" href="#sidebarTeacher" data-bs-toggle="collapse"
                        ...
                        <i class="mdi mdi-account-tie-hat"></i> <span
                            data-key="t-layouts">Manage Teachers</span>
                    </a>
                    <div class="collapse menu-dropdown" id="sidebarTeacher">
                        <ul class="nav nav-sm flex-column">
                            <li class="nav-item">
                                <a href="{{ route('teacher.index') }}" class="nav-link" data-key="t-horizontal">Teachers</a>
                                <a href="{{ route('teacher.index') }}" class="nav-link" data-key="t-horizontal">Create</a>
                            </li>
                        </ul>
                    </div>
                </li>
