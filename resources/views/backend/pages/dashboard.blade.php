                                ...
                                <div class="d-flex align-items-end justify-content-between mt-4">
                                    <div>
                                        <h4 class="fs-22 fw-semibold ff-secondary mb-4">Total: <span
                                                class="counter-value" data-target="{{$teachers}}">{{$teachers}}</span>
                                        </h4>
                ...
                <div class="card h-100 rounded-0">
                    <div class="card-body p-0">
                                    ...
                                    <div class="flex-grow-1 ms-3">
                                        ...
                                        <div
                                            ...
                                            <a href="apps-ecommerce-product-details.html"
                                                ...
                                                <img src="{{ asset('backend') }}/assets/images/products/img-8.png"
                                            ...
                                            <a href="apps-ecommerce-product-details.html"
                                                class="bg-light rounded p-1">
                                                <img src="{{ asset('backend') }}/assets/images/products/img-10.png"
                                                    alt="" class="img-fluid d-block" />
                                            </a>
                                        </div>
                        ...
                        <div class="card sidebar-alert bg-light border-0 text-center mx-4 mb-0 mt-3">
                            <div class="card-body">
                                <img src="{{ asset('backend') }}/assets/images/giftbox.png"
                                    alt="">
                                <div class="mt-4">
